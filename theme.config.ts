...
export default defineThemeConfig({
  name: 'Los Angeles Laners',
  id: 'accessible-astro-starter',
  logo: logoImage,
  seo: {
    title: 'The Los Angeles Laners, Inc.',
    description:
      'Next-Gen Management and Consulting for Business, Assets, and Entertainment',
    author: 'The Los Angeles Laners, Inc.',
